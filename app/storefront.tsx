...
export function Storefront() {
  ...
  return <main>
    ...
    <section id="top" className="hero">
      <div className="hero-copy"><p className="eyebrow">L'allure KiMiA</p><h1>La beauté<br/><em>vous appartient.</em></h1><p className="hero-text">Des couleurs pensées pour révéler votre lumière, avec assurance et intention.</p><a href="#nouveautes" className="button button-dark">Découvrir la collection <span>↗</span></a></div>
      <div className="hero-visual"><div className="sun-disc"></div><div className="hero-image"></div><p className="vertical-note">COULEUR · SOIN · CONFIANCE</p><p className="hero-caption">KiMiA<br/><span>beauty essentials</span></p></div>
    </section>
