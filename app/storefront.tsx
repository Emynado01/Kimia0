...
export function Storefront() {
  ...
  return <main>
    ...
    <header className="site-header">
      <a className="wordmark" href="#top" aria-label="KiMiA, accueil">KiMiA<span>·</span></a>
    ...
    <section className="journal" id="maison"><p className="eyebrow">Le journal KiMiA</p><div><h2>Des histoires<br/>à porter.</h2><a href="#newsletter" className="button button-light">Entrer dans le journal <span>↗</span></a></div></section>
